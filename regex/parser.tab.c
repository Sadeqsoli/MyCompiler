...
{
      10,     0,    -1,    11,     8,    -1,    11,     4,    12,    -1,
      12,    -1,    12,    13,    -1,    13,    -1,    14,     5,    -1,
      14,    -1,     3,    -1,     6,    11,     7,    -1
};
...
{
       0,   186,   186,   196,   197,   200,   201,   204,   205,   208,
     209
};
#endif
...
{
  "$end", "error", "$undefined", "SYMBOL", "OR", "STAR", "LPAREN",
  "RPAREN", "END", "$accept", "input", "regex", "term", "factor", "base", YY_NULL
};
#endif
...
#line 187 "parser.y"
    {
              nfa_to_grammar((yyvsp[(1) - (2)].frag).start);
              inline_units();
              drop_unreachable();
              bfs_rename();
              print_rules();
...
/* Line 1792 of yacc.c  */
#line 196 "parser.y"
    { (yyval.frag) = frag_union((yyvsp[(1) - (3)].frag),(yyvsp[(3) - (3)].frag)); }
    break;
...
/* Line 1792 of yacc.c  */
#line 200 "parser.y"
    { (yyval.frag) = frag_cat((yyvsp[(1) - (2)].frag),(yyvsp[(2) - (2)].frag)); }
    break;
...
/* Line 1792 of yacc.c  */
#line 204 "parser.y"
    { (yyval.frag) = frag_star((yyvsp[(1) - (2)].frag)); }
    break;
...
/* Line 1792 of yacc.c  */
#line 208 "parser.y"
    { (yyval.frag) = frag_sym((yyvsp[(1) - (1)].sym)); }
    break;

  case 10:
/* Line 1792 of yacc.c  */
#line 209 "parser.y"
    { (yyval.frag) = (yyvsp[(2) - (3)].frag); }
    break;
